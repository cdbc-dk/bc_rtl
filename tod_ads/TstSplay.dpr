...
{For every file in the current directory: compresses it to C:\LLL.SPL
...
begin
  ...
  try
    ...
    TDSplayCompress(InStrm, OutStrm);
  finally
    OutStrm.Free;
    InStrm.Free;
  end;
  ...
  try
    ...
    TDSplayDecompress(InStrm, OutStrm);
  finally
    OutStrm.Free;
    InStrm.Free;
  end;
